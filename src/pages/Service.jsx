      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 text-center lg:text-left">
          ...
          <div className="lg:w-7/12 max-w-2xl mx-auto lg:mx-0">
            <p
              className="text-sm uppercase font-bold tracking-widest mb-2"
  ...
  return (
    ...
    >
      <div className="mb-4">
        ...
        <h3 className="text-xl font-extrabold mb-1" style={{ color: COLORS.primaryDark }}>
          {service.title}
        </h3>

        <p className="text-xs font-semibold uppercase tracking-wide" style={{ color: COLORS.textGray }}>
      ...
      >
        ...
        <ArrowRight size={18} className="ml-1 mt-0.5 transition-transform group-hover:translate-x-1" />
      </div>
    </div>
  );
};
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-10">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-full border text-sm focus:outline-none focus:ring-2"
              style={{
                borderColor: '#E5E7EB',
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto mt-6">
              {audienceList.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl border-2 transition-all duration-300 hover:shadow-lg hover:border-opacity-100 transform hover:scale-[1.05] group"
                    style={{
...
// --------------------------------------------------------------------------------------------------
// 5. Online Session Section
// --------------------------------------------------------------------------------------------------

const OnlineSessionSection = ({ onNavigate }) => (
  <section className="py-16 md:py-24" style={{ background: COLORS.lightBackground }}>
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-white rounded-3xl p-8 md:p-16 shadow-2xl border border-gray-100">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-7/12">
            ...
            <p
              className="mb-6 leading-relaxed text-xl font-semibold"
              style={{ color: COLORS.primary }}
            >
            ...
            <p className="mb-10 leading-relaxed text-lg" style={{ color: COLORS.textGray }}>
              ...
              complex challenges, refine goals, and develop a strong, realistic plan
              for success.
            </p>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `0 4px 6px -1px ${COLORS.primary}10`,
                  }}
          ...
          {/* RIGHT CTA */}
          <div
            className="lg:w-5/12 w-full flex flex-col items-center justify-center p-10 rounded-3xl text-center shadow-inner"
            style={{
              backgroundColor: 'white',
              border: `4px solid ${COLORS.secondary}`,
              boxShadow: `0 0 0 10px ${COLORS.secondary}15`,
            }}
          >
            <MessageCircle
              size={70}
