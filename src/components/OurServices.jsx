...
import IconSubject from "./../assets/Icons/assesment.png";
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              >
                ...
                {/* Icon Container: Solid Primary Color (#1E3A8A) */}
                <div 
                ...
                >
                  <img
                    // service.icon now holds the URL string
                    src={service.icon} 
                ...
                {/* Link Indicator - Using consistent Secondary Color */}
                <span 
